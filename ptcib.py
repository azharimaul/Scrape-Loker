...
class PtcibSpider(scrapy.Spider):
    name = 'ptcib'
    allowed_domains = ['www.daftarperusahaan.com']
    start_urls = ['https://www.daftarperusahaan.com/bisnis/kecamatan/cibinong?page=0']
    ...
    def parse(self, response):
        ...
        for url in response.css("div.clear-block").css("h2").css("a::attr(href)"):     #loop list
            ...
            next_page = "https://www.daftarperusahaan.com/bisnis/kecamatan/cibinong?page=" + str(page)
            page += 1
            if page < 15:      #page limit
